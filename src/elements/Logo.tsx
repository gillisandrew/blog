...
export const Logo = ({ light, className }: LogoProps): JSX.Element => {
    const colors = !!light
        ? ['rgba(255, 255, 255, 0.9)', 'rgba(255, 255, 255, 0.8)', 'rgba(255, 255, 255, 1)']
        : ['#ff8e6f', '#ffc371', '#ff5f6d'];
    return (
        <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 500 458.43">
            <title>heyandrewlogo</title>
            <path
